  ...
  static void calc_wind()
    {
      ...
      wind_speed = (float) Math.sqrt(thermal_x_speed_total * thermal_x_speed_total +
                           ...
                           wind_thermal_count;
      System.out.println("Using "+wind_thermal_count+" climbs: wind speed = "+wind_speed+", wind direction = "+wind_direction);
    }
  ...
  void mouse_cursor(int x, int y)  // mouse clicked but not moved => set cursor
    {
      ...
      while (log.latitude[++min_index]==(float)0.0 && min_index<log.record_count) {;} // skip bad recs
